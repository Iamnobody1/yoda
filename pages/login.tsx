    ...
    <>
        ...
        <div className='w-full max-w-md space-y-8'>
          <div>
            <img
              ...
              alt='Workflow'
            />
            <h2 className='text-l mt-6 text-center text-gray-500'>
          ...
          <form className='mt-8 space-y-6' action='#' method='POST'>
            <label className='block'>
              ...
              <input
                ...
                className=' mt-1 block w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm placeholder-slate-400 placeholder-slate-400
      ...
      disabled:bg-slate-50 disabled:text-slate-500 disabled:shadow-none'
            ...
            <div>
              <button
                type='submit'
                className='group relative flex w-full justify-center rounded-full border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
              >
